...
<div class="container mt-4">
    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-lg rounded-lg p-6">
            <form action="{{ route('admin.volleyball.matches.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label>Team A</label>
        ...
        >
                ...
                <div class="mb-4">
                    ...
                    <textarea name="set_scores" rows="3" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500" placeholder='[{"a":25,"b":22}]'></textarea>
                </div>
